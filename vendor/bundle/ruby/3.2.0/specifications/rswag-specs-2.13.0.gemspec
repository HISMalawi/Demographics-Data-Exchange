...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 3.1".freeze, "< 7.2".freeze])
  s.add_runtime_dependency(%q<json-schema>.freeze, [">= 2.2".freeze, "< 5.0".freeze])
  s.add_runtime_dependency(%q<railties>.freeze, [">= 3.1".freeze, "< 7.2".freeze])
