...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<activejob>.freeze, [">= 4.2".freeze, "< 7.2".freeze])
  s.add_runtime_dependency(%q<redlock>.freeze, [">= 2.0".freeze, "< 3".freeze])
  s.add_development_dependency(%q<appraisal>.freeze, ["~> 2.3.0".freeze])
  ...
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 2.10".freeze])
end
