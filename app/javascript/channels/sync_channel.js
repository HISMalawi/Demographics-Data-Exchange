...
import { fetchStats } from "../troubleshooting";
...
function updateSyncStatus(data) {
  ...
  // Success: stop animation, update button & message, then fetch stats
  ...
  // Failure: stop animation, update button & message, then fetch stats
