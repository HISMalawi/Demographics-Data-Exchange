...
module Api
  module V1
    ...
    class SyncController < ApplicationController
      ...
      def push_params
        params.permit(:id, :last_name, :first_name, :middle_name, :gender,
                      :current_village, :current_traditional_authority, :current_district,
                      :home_village, :home_traditional_authority, :home_district,
                      :birthdate, :birthdate_estimated, :person_uuid, :npid,
                      :date_registered, :last_edited, :location_created_at, :location_updated_at,
                      :creator, :home_ta, :ancestry_village, :ancestry_ta, :ancestry_district,
                      :voided, :voided_by, :date_voided, :void_reason, :first_name_soundex,
                      :last_name_soundex, :update_seq)
      end
