...
RSpec.describe "/api/v1/people_details", type: :request do
  ...
  # Api::V1::PeopleDetail. As you add validations to Api::V1::PeopleDetail, be sure to
  ...
  describe "GET /show" do
    it "renders a successful response" do
      people_detail = Api::V1::PeopleDetail.create! valid_attributes
      get api_v1_people_detail_url(api_v1_people_detail), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested api/v1_people_detail" do
        people_detail = Api::V1::PeopleDetail.create! valid_attributes
        patch api_v1_people_detail_url(api_v1_people_detail),
              params: { api_v1_people_detail: new_attributes }, headers: valid_headers, as: :json
        people_detail.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the api/v1_people_detail" do
        people_detail = Api::V1::PeopleDetail.create! valid_attributes
        patch api_v1_people_detail_url(api_v1_people_detail),
              params: { api_v1_people_detail: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the api/v1_people_detail" do
        people_detail = Api::V1::PeopleDetail.create! valid_attributes
        patch api_v1_people_detail_url(api_v1_people_detail),
              params: { api_v1_people_detail: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq("application/json")
      end
    end
  ...
  describe "DELETE /destroy" do
    it "destroys the requested api/v1_people_detail" do
      people_detail = Api::V1::PeopleDetail.create! valid_attributes
      expect {
        delete api_v1_people_detail_url(api_v1_people_detail), headers: valid_headers, as: :json
      }.to change(Api::V1::PeopleDetail, :count).by(-1)
    end
  end
end
